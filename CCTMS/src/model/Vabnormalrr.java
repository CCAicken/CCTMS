...
public class Vabnormalrr implements java.io.Serializable {
	...
	public Vabnormalrr(Integer alid, Integer arid, Integer lrid,
			String createdate, Integer lid, Integer daid, String tthresho,
	...
	/** full constructor */
	public Vabnormalrr(Integer alid, Integer arid, Integer lrid,
			String imageurl, String voiceurl, String createdate,
			String voideurl, String txtcontent, Integer lid, Integer daid,
			String tthresho, String lineArrangeRemarks, String taskname,
			Boolean lineStatus, String startpoint, String endpoint,
			String userid, Integer carid, String carNum, Boolean carStatus,
			Boolean fanStatus, String carRemarks, String userName, String sex,
			String tel, Boolean userStatus) {
		this.alid = alid;
		this.arid = arid;
		this.lrid = lrid;
